...
class OfflineSender(object):
        ...
        if self.use_http_messages:
            ...
            for item in message_items:
                self._send_ws_message(
                    message=item.message, offset=item.message.message_id
                )
    ...
    def _send_ws_message(
        self, message: BaseMessage, offset: Optional[int] = None
    ) -> None:
    ...
    def _send_metric_message(self, message: Dict[str, Any]) -> None:
